...
```diff
DATABASE_URL="postgresql://postgres.REDACTED_DB_HOST:6543/postgres?pgbouncer=true&connection_limit=1"
+ DIRECT_URL="postgresql://postgres.REDACTED_DB_HOST:5432/postgres"
```
...
+ JWT_SECRET="REDACTED_ROTATE_JWT"
```
