...
export async function initDb() {
    ...
    if (!layout) {
        console.log("[initDb] Creating default layout...");
        ...
        console.log("[initDb] Adjacency graph synchronized.");
    }

    // 2. Define Tables
    const tables = [
        { id: "T1", x: 280, y: 480, width: 120, height: 70, shape: "RECTANGLE", min: 2, max: 4, type: "STANDARD", pri: 80 }, // Zone B
        { id: "T2", x: 440, y: 480, width: 120, height: 70, shape: "RECTANGLE", min: 2, max: 4, type: "STANDARD", pri: 80 }, // Zone B
        { id: "T3", x: 600, y: 480, width: 120, height: 70, shape: "RECTANGLE", min: 2, max: 4, type: "STANDARD", pri: 80 }, // Zone B
        { id: "T15", x: 830, y: 450, width: 120, height: 70, shape: "RECTANGLE", min: 1, max: 20, type: "STANDARD", pri: 0 },
        { id: "T7", x: 50, y: 400, width: 120, height: 70, shape: "RECTANGLE", min: 2, max: 4, type: "STANDARD", pri: 60 }, // Zone C
        { id: "T8", x: 50, y: 300, width: 120, height: 70, shape: "RECTANGLE", min: 2, max: 4, type: "STANDARD", pri: 60 }, // Zone C
        ...
        { id: "T14", x: 830, y: 320, width: 120, height: 70, shape: "RECTANGLE", min: 2, max: 4, type: "STANDARD", pri: 50 },
        { id: "T9", x: 50, y: 50, width: 120, height: 150, shape: "RECTANGLE", min: 6, max: 12, type: "MERGED_FIXED", pri: 100 }, // Zone A
        { id: "T10", x: 220, y: 80, width: 70, height: 110, shape: "RECTANGLE", min: 2, max: 4, type: "STANDARD", pri: 110 }, // Zone A (Inner Hand)
        { id: "T11", x: 350, y: 80, width: 220, height: 70, shape: "RECTANGLE", min: 8, max: 12, type: "MERGED_FIXED", pri: 150 }, // Zone A (HEAD)
        { id: "T12", x: 650, y: 80, width: 70, height: 110, shape: "RECTANGLE", min: 2, max: 4, type: "STANDARD", pri: 110 }, // Zone A (Inner Hand)
